...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02db\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x1cgoogle/api/annotations.proto2\xba\x01\n" +
	"\n" +
	"SimpleBank\x12W\n" +
	"\n" +
	...
	"\tLoginUser\x12\x14.db.LoginUserRequest\x1a\x15.db.LoginUserResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB$Z\"github.com/akshay-xp/simplebank/pbb\x06proto3"
