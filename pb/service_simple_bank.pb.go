...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02db\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto2\x87\x01\n" +
	"\n" +
	"SimpleBank\x12=\n" +
	"\n" +
	"CreateUser\x12\x15.db.CreateUserRequest\x1a\x16.db.CreateUserResponse\"\x00\x12:\n" +
	"\tLoginUser\x12\x14.db.LoginUserRequest\x1a\x15.db.LoginUserResponse\"\x00B$Z\"github.com/akshay-xp/simplebank/pbb\x06proto3"
